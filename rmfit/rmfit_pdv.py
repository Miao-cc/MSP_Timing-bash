...
def loadData(filename):
    ...
    if os.path.exists(archiveFileName):
        arch = psrchive.Archive_load(archiveFileName)
...
def main(filename):
    ...
    global outRootName
    outRootName = 'rmResult/FRB-RM_%s_%s_subint_%s_%s_' % (rm_s, rm_e, pulsarData['start_subint'], pulsarData['end_endint'])
    rm_len = rm_e - rm_s
